...
const backgroundContents = [
    ...
    },
    {
        ...
        underline: "Explore Nutrition"
    },
    {
        header: "Got Questions? Have feedback?",
        description: "Reach out and we are here to help guide you. Our team is here ready to answer any of your questions.",
            ...
            {!isFirstSection && (
                ...
                >
                    <div style={{ padding: '20px' }}>
                        <h2 style={fontStyles.header}>{content.header}</h2>
                        <p style={fontStyles.body}>{content.description}</p>
                        <span style={fontStyles.underline}>{content.underline}</span>
                    </div>
                </div>
            )}
